...
sed -i -E "s#TEST_ALPHA_META_SERVICE_NAME#${FAT_ALPHA_META_SERVICE_NAME}#g" ${meta_server_config}.cp
sed -i -E "s#TEST_BETA_META_SERVICE_NAME#${UAT_BETA_META_SERVICE_NAME}#g" ${meta_server_config}.cp
sed -i -E "s#PROD_META_SERVICE_NAME#${PRO_META_SERVICE_NAME}#g" ${meta_server_config}.cp
